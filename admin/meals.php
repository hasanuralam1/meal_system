...
<div class="p-4 bg-gray-50 border-b flex flex-wrap gap-4 items-end">
  ...
  <div>
    ...
    <input id="f_meal_name" type="text"
  ...
  <div>
    ...
    <select id="f_day" class="border px-3 py-2 rounded text-sm w-32">
  ...
  <div>
    ...
    <select id="f_night" class="border px-3 py-2 rounded text-sm w-32">
      <option value="">All</option>
      <option value="1">Yes</option>
      <option value="0">No</option>
    </select>
  ...
  <div>
    ...
    <select id="f_day_name" class="border px-3 py-2 rounded text-sm w-40">
      <option value="">All</option>
      <option value="sunday">Sunday</option>
      <option value="monday">Monday</option>
      <option value="tuesday">Tuesday</option>
...
async function fetchMeals() {
  ...
  const payload = {
    meal_name: document.getElementById("f_meal_name")?.value || "",
    date: document.getElementById("f_date")?.value || "",
    day: document.getElementById("f_day")?.value || "",
    night: document.getElementById("f_night")?.value || "",
    day_name: document.getElementById("f_day_name")?.value || "",
    limit: limit,
    offset: offset
  };
...
<script>
["f_meal_name","f_date","f_day","f_night","f_day_name"]
.forEach(id => {
...
function resetFilters() {
  ...
  document.getElementById("f_night").value = "";
  document.getElementById("f_day_name").value = "";
  offset = 0;
  fetchMeals();
}
</script>
